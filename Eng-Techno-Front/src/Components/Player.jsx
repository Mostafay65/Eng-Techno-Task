...
const Player = () => {
    ...
    return (
        <>
            {/* Mobile Player */}
            <div className="lg:hidden bg-[#8257E5] h-20 flex items-center justify-between text-white px-4">
                {selectedIndex === -1 ? (
                    <div className="flex items-center justify-center w-full">
                        <span className="text-sm text-[#C1ABF2]">Selecione um podcast para ouvir</span>
                    </div>
                ) : (
                    <>
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                                <h3 className="font-semibold text-sm line-clamp-1">{podcasts[selectedIndex].title}</h3>
                                <p className="text-xs text-[#C1ABF2] line-clamp-1">{podcasts[selectedIndex].authors}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="hover:bg-[#9164FA] p-1 rounded transition-colors duration-200"
                            >
                            ...
                            {!isPlaying && (
                                <button
                                    disabled={selectedIndex === -1}
                                    onClick={playAudio}
                                    className="bg-[#9164FA] rounded-lg w-8 h-8 flex items-center justify-center"
                                >
                                    <svg
                                        width="12"
                                        height="14"
                            ...
                            {isPlaying && (
                                <button
                                    onClick={pauseAudio}
                                    className="bg-[#6F48C9] rounded-lg w-8 h-8 flex items-center justify-center"
                                >
                                    <svg width="8" height="14" viewBox="0 0 11 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            {/* Desktop Player */}
            <div className="hidden lg:flex bg-[#8257E5] h-screen flex-col items-center justify-between text-white p-4">
